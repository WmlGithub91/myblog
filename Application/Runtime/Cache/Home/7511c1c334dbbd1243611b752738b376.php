...
<div class="am-g am-g-fixed blog-fixed blog-content">
  <figure data-am-widget="figure" class="am am-figure am-figure-default "   data-am-figure="{  pureview: 'true' }">
      <div id="container"> 
      <?php if(is_array($imgs)): foreach($imgs as $key=>$s): ?><div><img src="/myblog/Public<?php echo ($s['pic']); ?>"><h3><?php echo ($s['keywords']); ?></h3></div><?php endforeach; endif; ?>
...
<script src="/myblog/Public/Home/assets/js/pinto.min.js"></script>
<script src="/myblog/Public/Home/assets/js/img.js"></script>
</body>
</html>