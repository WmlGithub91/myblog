            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        <a href="<?php echo U('user_add');?>" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            New User
                        </a>
                    </div>
...
<?php if(is_array($users)): foreach($users as $key=>$v): ?><tbody>
                        <tr>
                            <td>
                                <img src="<?php if($v['head_pic'] == '' ): ?>/myblog/Public/Admin/img/avatar.jpg<?php else: ?>/myblog/Public/<?php echo ($v['head_pic']); endif; ?>" class="img-circle avatar hidden-phone" />
                                <a href="" class="name"><?php echo ($v['username']); ?></a>
                                <span class="subtext"><?php echo ($v['realname']); ?></span>
                            </td>
                            <td>
                            <?php if(is_array($roles)): foreach($roles as $key=>$r): if($v['roleid'] == $r['id']): echo ($r['rolename']); endif; endforeach; endif; ?>
                            </td>

                            <td>
                            <?php echo date('Y-m-d',$v['reg_time']); ?>
      
                            </td>
                         <td >
                                    <a href="<?php echo U('user_edit',array('id'=>$v['id']));?>"><i class="table-edit"></i></a>&nbsp;&nbsp;
                                    <a href="<?php echo U('user_del',array('id'=>$v['id']));?>" onclick="return confirm('确定删除该管理员吗?');"><i class="table-delete"></i></a>
                        </td>
                        </tr>
