...
-->          
    ...
    <div class="content">
      ...
      <form action="<?php echo U('link_sort');?>" method="post">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th class="span3 sortable">
                                    <span class="line"></span>友情链接排序
                                </th>
                                <th class="span3 sortable">
                                    <span class="line"></span>友情链接名称
                                </th>
                                <th class="span3 sortable">
                                    <span class="line"></span>友情链接url
                                </th>     
...
<?php if(is_array($links)): foreach($links as $key=>$v): ?><tr>
                           <td class="center">
                           <input type="text" name="<?php echo ($v['id']); ?>" value="<?php echo ($v['sort']); ?>" style="width: 30px;text-align: center;"> 
                              </td>
                              <td>
<?php echo ($v['linkname']); ?>
                            </td>
...
<?php echo ($v['linkurl']); ?>
                         ...
                         <td >
                                    ...
                                    <a href="<?php echo U('del',array('id'=>$v['id']));?>" onclick="return confirm('确定删除该友情链接吗?');"><i class="table-delete"></i></a>
                        </td>
