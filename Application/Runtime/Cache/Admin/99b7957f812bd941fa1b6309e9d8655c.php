                    ...
                    <div class="span8 column">
                        <form action="" method="post" class="new_user_form inline-input" enctype="multipart/form-data" />
                          <input type="hidden" name="id" value="<?php echo ($ins['id']); ?>">
                              <div class="field-box">
                                <label>网站logo:</label>
                                <input type="file" name="logo_pic" value="" placeholder="">
                                <img width="150px;" height="150px;" src="/myblog/Public<?php echo ($ins['logo_pic']); ?>" alt="">

                            </div>                                
                                                    
                            <div class="field-box">
                                <label>后台首页内容:</label>
                                <textarea id="content" name="content" class="span8" rows="4" style="margin-left: 0px;"><?php echo ($ins['content']); ?></textarea>
                            </div>                    
