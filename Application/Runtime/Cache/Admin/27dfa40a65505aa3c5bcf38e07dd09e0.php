...
<head>
    ...
    <link rel="stylesheet" href="/myblog/Public/Admin/css/compiled/tables.css" type="text/css" media="screen" />
            ...
            <div id="pad-wrapper">
                ...
                <div class="table-wrapper users-table section">
                    ...
                    <div class="row-fluid filter-block">
                        ...
                        <form action="<?php echo U('Log/login_log');?>" method="get">
                            <!-- <a class="btn-flat pull-right success new-product add-user">+ Add user</a> -->
                            <input type="text" name="keywords" placeholder="Search for log.." />
                            <input type="submit" name="" value="查询" style="margin-bottom: 10px; font-size: 12px;padding: 0.2px 3px; border-radius:5px; color:rgb(105, 109, 115);">
                            </form>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="span3">
                                        <span class="line"></span>Login time
                                    </th>
                                </tr>
                            </thead>
                            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tbody>
                                ...
                                <tr class="first">
                                    <td>
                                        <img src="/myblog/Public<?php echo ($v['head_pic']); ?>" class="img-circle avatar hidden-phone" />
