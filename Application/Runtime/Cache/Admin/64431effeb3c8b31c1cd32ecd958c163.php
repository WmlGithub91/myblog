...
<head>
    ...
    <link rel="stylesheet" href="/myblog/Public/Admin/css/page.css" type="text/css" media="screen" />
...
<?php if(is_array($roles)): foreach($roles as $key=>$v): ?><tbody>
                        <tr>
                            <td>
                               <?php echo ($v['rolename']); ?>
                            </td>
                            <td >
                                <?php if($v['pri_id_list'] == '*'): ?>所有权限
                                <?php else: ?>
                        <?php echo ($v['pri_name']); endif; ?>
                            </td>
                         <td>
                                    <a href="<?php echo U('edit',array('id'=>$v['id']));?>"><i class="table-edit"></i></a>&nbsp;&nbsp;
                                    <a href="<?php echo U('del',array('id'=>$v['id']));?>" onclick="return confirm('确定删除该角色吗?');"><i class="table-delete"></i></a>
                         </td>
                        </tr>
