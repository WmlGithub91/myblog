                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="span3 sortable">
                                    <span class="line"></span>模块
                                </th>   
                                <th class="span3 sortable">
                                    <span class="line"></span>控制器
                                </th> 
                                <th class="span3 sortable">
                                    <span class="line"></span>方法
                                </th> 
...
<?php if(is_array($pris)): foreach($pris as $key=>$v): ?><tbody>
                        <tr>
                            <td>
                             <?php echo str_repeat('-',$v['lev']*8); ?>  <?php echo ($v['pri_name']); ?>
                            </td>
                            <td >
                            <?php echo ($v['mname']); ?>
                             </td>
                         ...
                         <td >
                                    ...
                                    <a href="<?php echo U('del',array('id'=>$v['id']));?>" onclick="return confirm('确定删除该权限吗?');"><i class="table-delete"></i></a>
                        </td>
                        </tr>
