...
<head>
    ...
    <!-- libraries -->
    <link href="/meng/Public/Admin/css/lib/bootstrap-wysihtml5.css" type="text/css" rel="stylesheet" />
    <link href="/meng/Public/Admin/css/lib/uniform.default.css" type="text/css" rel="stylesheet" />
    <link href="/meng/Public/Admin/css/lib/select2.css" type="text/css" rel="stylesheet" />
    <link href="/meng/Public/Admin/css/lib/bootstrap.datepicker.css" type="text/css" rel="stylesheet" />
    <link href="/meng/Public/Admin/css/lib/font-awesome.css" type="text/css" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="/meng/Public/Admin/css/compiled/form-showcase.css" type="text/css" media="screen" />
...
-->          
           ...
           <li <?php if($Think.CONTROLLER_NAME == 'Article'){ echo 'class="active"';} ; ?>>
            ...
            <li  <?php if($Think.CONTROLLER_NAME == 'User' || $Think.CONTROLLER_NAME == 'Role' || $Think.CONTROLLER_NAME == 'Privilege' ){ echo 'class="active"';} ; ?>>
              ...
              <li  <?php if($Think.CONTROLLER_NAME == 'User' ){ echo 'class="active"';} ; ?>>
                <a class="dropdown-toggle" href="#">
                    <i class="icon-move"></i>
                    <span>友情链接</span>
                    <i class="icon-chevron-down"></i>
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span8 column">
                        ...
                        <input type="hidden" name="id" value="<?php echo ($links['id']); ?>">
                            <div class="field-box">
                                <label>友情链接名称:</label>
                                <input class="span8 inline-input" name="linkname" type="text" value="<?php echo ($links['linkname']); ?>" />
                            </div> 
                           
                            <div class="field-box">
                                <label>友情链接url:</label>
                                <input class="span8 inline-input" name="linkurl" type="text" value="<?php echo ($links['linkurl']); ?>" />
                            </div>                     
                            

                                <div class="span11 field-box actions" style="margin-left: 700px;">
                                    <input type="submit" class="btn-glow primary" value="修改友情链接" />
                                </div>
                        </form>
                    </div>
    ...
    <script src="/meng/Public/Admin/js/wysihtml5-0.3.0.js"></script>
    <script src="/meng/Public/Admin/js/jquery-latest.js"></script>
    <script src="/meng/Public/Admin/js/bootstrap.min.js"></script>
    <script src="/meng/Public/Admin/js/bootstrap-wysihtml5-0.0.2.js"></script>
    <script src="/meng/Public/Admin/js/bootstrap.datepicker.js"></script>
    <script src="/meng/Public/Admin/js/jquery.uniform.min.js"></script>
    <script src="/meng/Public/Admin/js/select2.min.js"></script>
