                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span8 column">
                        <form action="" method="post" class="new_user_form inline-input" enctype="multipart/form-data" />
                            <div class="field-box">
                                <label>友情链接名称:</label>
                                <input class="span8 inline-input" name="linkname" type="text" />
                            </div> 
                           
                            <div class="field-box">
                                <label>友情链接url:</label>
                                <input class="span8 inline-input" name="linkurl" type="text" value="" />
                            </div>                     
                            

                                <div class="span11 field-box actions" style="margin-left: 700px;">
                                    <input type="submit" class="btn-glow primary" value="新增友情链接" />
                                </div>
                        </form>
                    </div>
