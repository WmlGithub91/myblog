                        ...
                        <div class="container">
                            ...
                            <input type="hidden" name="id" value="<?php echo ($info['id']); ?>">
                                <div class="span12 field-box">
                                    ...
                                    <input name="username" class="span9" type="text" value="<?php echo ($info['username']); ?>" />
                                </div>
                                <div class="span12 field-box">
                                    <label>RealName:</label>
                                    <input name="realname" class="span9" type="text" value="<?php echo ($info['realname']); ?>" />
                                </div>
                                <div class="span12 field-box">
                                    <label>Email:</label>
                                    <input name="email" class="span9" type="text" value="<?php echo ($info['email']); ?>" />
                                </div>
                                <div class="span12 field-box">
                                    <label>Phone:</label>
                                    <input name="phone" class="span9" type="text" value="<?php echo ($info['phone']); ?>" />
                                </div>
                                   <div class="span12 field-box">
                                    <label>Role:</label>
                                    <div class="ui-select span5">
                                        <select name="roleid">
                                    <?php if(is_array($roles)): foreach($roles as $key=>$v): ?><option value="<?php echo ($v['id']); ?>" <?php if($v['id'] == $info['roleid']): ?>selected="selected"<?php endif; ?> /><?php echo ($v['rolename']); endforeach; endif; ?>
                                        </select>
                                    </div>
                                </div>
                                 <div class="span12 field-box">
                                  <img src="<?php if($info['head_pic'] == '' ): ?>/meng/Public/Admin/img/avatar.jpg<?php else: ?>/meng/Public/<?php echo ($info['head_pic']); endif; ?>" alt="">
                                </div>                               
                                <div class="span12 field-box">
                                ...
                                <div class="span11 field-box actions">
                                    <input class="submit" type="submit" class="btn-glow primary" value="Revise user" />
                                </div>
                            </form>
                        </div>
                    </div>
